 ...
 *
 * Schema Io_k8s_api_resource_v1alpha2_resource_class_parameters_list.t : ResourceClassParametersList is a collection of ResourceClassParameters.
 *)
...
type t = {
    ...
    items: Io_k8s_api_resource_v1alpha2_resource_class_parameters.t list [@default []] [@yojson.key "items"];
