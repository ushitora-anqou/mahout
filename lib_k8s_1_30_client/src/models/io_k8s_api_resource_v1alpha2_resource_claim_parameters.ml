 ...
 *
 * Schema Io_k8s_api_resource_v1alpha2_resource_claim_parameters.t : ResourceClaimParameters defines resource requests for a ResourceClaim in an in-tree format understood by Kubernetes.
 *)
...
type t = {
    ...
    driver_requests: Io_k8s_api_resource_v1alpha2_driver_requests.t list [@default []] [@yojson.key "driverRequests"];
    generated_from: Io_k8s_api_resource_v1alpha2_resource_claim_parameters_reference.t option [@yojson.default None] [@yojson.key "generatedFrom"];
