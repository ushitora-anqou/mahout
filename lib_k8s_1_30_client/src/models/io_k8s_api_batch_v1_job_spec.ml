...
type t = {
    ...
    managed_by: string option [@yojson.default None] [@yojson.key "managedBy"];
    ...
    success_policy: Io_k8s_api_batch_v1_success_policy.t option [@yojson.default None] [@yojson.key "successPolicy"];
