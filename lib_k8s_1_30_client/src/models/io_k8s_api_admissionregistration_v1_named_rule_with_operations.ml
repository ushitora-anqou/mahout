 ...
 *
 * Schema Io_k8s_api_admissionregistration_v1_named_rule_with_operations.t : NamedRuleWithOperations is a tuple of Operations and Resources with ResourceNames.
 *)
