...
type t = {
    ...
    endpoints: Io_k8s_api_discovery_v1_endpoint.t list [@default []] [@yojson.key "endpoints"];
    ...
    ports: Io_k8s_api_discovery_v1_endpoint_port.t list [@default []] [@yojson.key "ports"];
