 ...
 *
 * Schema Io_k8s_api_resource_v1alpha2_resource_slice.t : ResourceSlice provides information about available resources on individual nodes.
 *)
...
type t = {
    ...
    named_resources: Io_k8s_api_resource_v1alpha2_named_resources_resources.t option [@yojson.default None] [@yojson.key "namedResources"];
