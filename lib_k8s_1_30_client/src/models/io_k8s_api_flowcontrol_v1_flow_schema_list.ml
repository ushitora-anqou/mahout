 ...
 *
 * Schema Io_k8s_api_flowcontrol_v1_flow_schema_list.t : FlowSchemaList is a list of FlowSchema objects.
 *)
...
type t = {
    ...
    items: Io_k8s_api_flowcontrol_v1_flow_schema.t list [@default []] [@yojson.key "items"];
