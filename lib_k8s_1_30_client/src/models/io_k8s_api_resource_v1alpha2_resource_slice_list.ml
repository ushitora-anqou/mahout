 ...
 *
 * Schema Io_k8s_api_resource_v1alpha2_resource_slice_list.t : ResourceSliceList is a collection of ResourceSlices.
 *)
...
type t = {
    ...
    items: Io_k8s_api_resource_v1alpha2_resource_slice.t list [@default []] [@yojson.key "items"];
