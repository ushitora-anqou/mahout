 ...
 *
 * Schema Io_k8s_api_networking_v1alpha1_service_cidr_list.t : ServiceCIDRList contains a list of ServiceCIDR objects.
 *)
...
type t = {
    ...
    items: Io_k8s_api_networking_v1alpha1_service_cidr.t list [@default []] [@yojson.key "items"];
