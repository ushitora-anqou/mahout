...
type t = {
    ...
    match_expressions: Io_k8s_api_core_v1_node_selector_requirement.t list [@default []] [@yojson.key "matchExpressions"];
    (* A list of node selector requirements by node's fields. *)
    match_fields: Io_k8s_api_core_v1_node_selector_requirement.t list [@default []] [@yojson.key "matchFields"];
