 ...
 *
 * Schema Io_k8s_api_resource_v1alpha2_resource_claim_parameters_list.t : ResourceClaimParametersList is a collection of ResourceClaimParameters.
 *)
...
type t = {
    ...
    items: Io_k8s_api_resource_v1alpha2_resource_claim_parameters.t list [@default []] [@yojson.key "items"];
