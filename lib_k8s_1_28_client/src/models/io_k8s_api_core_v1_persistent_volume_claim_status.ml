...
type t = {
    ...
    allocated_resource_statuses: Yojson.Safe.t [@default (`List [])] [@key "allocatedResourceStatuses"];
    ...
    conditions: Io_k8s_api_core_v1_persistent_volume_claim_condition.t list [@default []] [@key "conditions"];
...
let create () : t = {
    access_modes = [];
    allocated_resource_statuses = `List [];
