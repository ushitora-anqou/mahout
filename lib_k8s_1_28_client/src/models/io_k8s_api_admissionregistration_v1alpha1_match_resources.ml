...
type t = {
    ...
    exclude_resource_rules: Io_k8s_api_admissionregistration_v1alpha1_named_rule_with_operations.t list [@default []] [@yojson.key "excludeResourceRules"];
    ...
    resource_rules: Io_k8s_api_admissionregistration_v1alpha1_named_rule_with_operations.t list [@default []] [@yojson.key "resourceRules"];
