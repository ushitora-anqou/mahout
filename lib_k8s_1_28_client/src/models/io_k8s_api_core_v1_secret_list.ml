 ...
 *
 * Schema Io_k8s_api_core_v1_secret_list.t : SecretList is a list of Secret.
 *)
...
type t = {
    ...
    items: Io_k8s_api_core_v1_secret.t list [@default []] [@key items];
...
let create (items : Io_k8s_api_core_v1_secret.t list) : t = {
    api_version = None;
    items = items;
    kind = None;
    metadata = None;
