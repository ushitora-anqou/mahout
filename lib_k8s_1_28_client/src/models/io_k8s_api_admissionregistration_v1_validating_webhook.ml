...
type t = {
    ...
    match_conditions: Io_k8s_api_admissionregistration_v1_match_condition.t list [@yojson.default []] [@yojson.key "matchConditions"];
    ...
    rules: Io_k8s_api_admissionregistration_v1_rule_with_operations.t list [@yojson.default []] [@yojson.key "rules"];
