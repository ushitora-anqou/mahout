...
type t = {
    ...
    admission_review_versions: string list [@default []];
    client_config: Io_k8s_api_admissionregistration_v1_webhook_client_config.t;
    ...
    match_conditions: Io_k8s_api_admissionregistration_v1_match_condition.t list [@default []];
    ...
    rules: Io_k8s_api_admissionregistration_v1_rule_with_operations.t list [@default []];
