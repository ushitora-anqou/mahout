...
type t = {
    ...
    spec: Io_k8s_api_authorization_v1_self_subject_access_review_spec.t [@key spec];
...
let create (spec : Io_k8s_api_authorization_v1_self_subject_access_review_spec.t) : t = {
    api_version = None;
    kind = None;
    metadata = None;
    spec = spec;
