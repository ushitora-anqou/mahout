...
type t = {
    ...
    fields_type: string option [@default None] [@key "fieldsType"];
    ...
    fields_v1: Yojson.Safe.t option [@default None] [@key "fieldsV1"];
    (* Manager is an identifier of the workflow managing these fields. *)
    manager: string option [@default None] [@key "manager"];
    (* Operation is the type of operation which lead to this ManagedFieldsEntry being created. The only valid values for this field are 'Apply' and 'Update'. *)
    operation: string option [@default None] [@key "operation"];
