...
type t = {
    ...
    container_statuses: Io_k8s_api_core_v1_container_status.t list [@yojson.default []] [@yojson.key "containerStatuses"];
    (* Status for any ephemeral containers that have run in this pod. *)
    ephemeral_container_statuses: Io_k8s_api_core_v1_container_status.t list [@yojson.default []] [@yojson.key "ephemeralContainerStatuses"];
    ...
    host_ips: Io_k8s_api_core_v1_host_ip.t list [@yojson.default []] [@yojson.key "hostIPs"];
    (* The list has one entry per init container in the manifest. The most recent successful init container will have ready = true, the most recently started container will have startTime set. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status *)
    init_container_statuses: Io_k8s_api_core_v1_container_status.t list [@yojson.default []] [@yojson.key "initContainerStatuses"];
    ...
    pod_ips: Io_k8s_api_core_v1_pod_ip.t list [@yojson.default []] [@yojson.key "podIPs"];
