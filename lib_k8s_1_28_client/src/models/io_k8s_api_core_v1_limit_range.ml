 ...
 *
 * Schema Io_k8s_api_core_v1_limit_range.t : LimitRange sets resource usage limits for each kind of resource in a Namespace.
 *)
...
type t = {
    ...
    spec: Io_k8s_api_core_v1_limit_range_spec.t option [@yojson.default None] [@yojson.key "spec"];
