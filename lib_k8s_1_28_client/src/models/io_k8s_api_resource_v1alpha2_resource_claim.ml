 ...
 *
 * Schema Io_k8s_api_resource_v1alpha2_resource_claim.t : ResourceClaim describes which resources are needed by a resource consumer. Its status tracks whether the resource has been allocated and what the resulting attributes are.  This is an alpha type and requires enabling the DynamicResourceAllocation feature gate.
 *)
...
type t = {
    ...
    status: Io_k8s_api_resource_v1alpha2_resource_claim_status.t option [@default None];
