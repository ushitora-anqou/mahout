...
type t = {
    ...
    allow_privilege_escalation: bool option [@default None];
    capabilities: Io_k8s_api_core_v1_capabilities.t option [@default None];
    ...
    proc_mount: string option [@default None];
    (* Whether this container has a read-only root filesystem. Default is false. Note that this field cannot be set when spec.os.name is windows. *)
    read_only_root_filesystem: bool option [@default None];
