 ...
 *
 * Schema Io_k8s_api_coordination_v1_lease.t : Lease defines a lease concept.
 *)
...
type t = {
    ...
    spec: Io_k8s_api_coordination_v1_lease_spec.t option [@yojson.default None] [@yojson.key "spec"];
