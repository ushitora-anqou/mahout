...
type t = {
    ...
    addresses: Io_k8s_api_core_v1_node_address.t list;
    ...
    conditions: Io_k8s_api_core_v1_node_condition.t list;
    ...
    images: Io_k8s_api_core_v1_container_image.t list;
    ...
    volumes_attached: Io_k8s_api_core_v1_attached_volume.t list;
    (* List of attachable volumes in use (mounted) by the node. *)
    volumes_in_use: string list;
