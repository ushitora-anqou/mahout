...
type t = {
    ...
    secret_ref: Io_k8s_api_core_v1_local_object_reference.t [@key "secretRef"];
...
let create (gateway : string) (secret_ref : Io_k8s_api_core_v1_local_object_reference.t) (system : string) : t = {
    fs_type = None;
    gateway = gateway;
