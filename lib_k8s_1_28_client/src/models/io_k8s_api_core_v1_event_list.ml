 ...
 *
 * Schema Io_k8s_api_core_v1_event_list.t : EventList is a list of events.
 *)
...
type t = {
    ...
    (* List of events *)
    items: Io_k8s_api_core_v1_event.t list [@default []] [@key "items"];
...
let create (items : Io_k8s_api_core_v1_event.t list) : t = {
    api_version = None;
    items = items;
    kind = None;
    metadata = None;
