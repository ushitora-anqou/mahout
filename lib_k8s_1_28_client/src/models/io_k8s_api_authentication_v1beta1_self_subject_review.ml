 ...
 *
 * Schema Io_k8s_api_authentication_v1beta1_self_subject_review.t : SelfSubjectReview contains the user information that the kube-apiserver has about the user making this request. When using impersonation, users will receive the user info of the user being impersonated.  If impersonation or request header authentication is used, any extra keys will have their case ignored and returned as lowercase.
 *)
...
type t = {
    ...
    status: Io_k8s_api_authentication_v1beta1_self_subject_review_status.t option [@yojson.default None] [@yojson.key "status"];
