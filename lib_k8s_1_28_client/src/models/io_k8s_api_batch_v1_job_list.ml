 ...
 *
 * Schema Io_k8s_api_batch_v1_job_list.t : JobList is a collection of jobs.
 *)
...
type t = {
    ...
    items: Io_k8s_api_batch_v1_job.t list [@default []] [@key items];
...
let create (items : Io_k8s_api_batch_v1_job.t list) : t = {
    api_version = None;
    items = items;
    kind = None;
    metadata = None;
