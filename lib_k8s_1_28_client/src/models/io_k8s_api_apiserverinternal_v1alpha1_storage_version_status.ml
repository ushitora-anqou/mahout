...
type t = {
    ...
    conditions: Io_k8s_api_apiserverinternal_v1alpha1_storage_version_condition.t list [@default []];
    (* The reported versions per API server instance. *)
    storage_versions: Io_k8s_api_apiserverinternal_v1alpha1_server_storage_version.t list [@default []];
