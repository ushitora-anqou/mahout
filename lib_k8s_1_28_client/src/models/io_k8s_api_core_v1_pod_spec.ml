...
type t = {
    ...
    containers: Io_k8s_api_core_v1_container.t list;
    ...
    ephemeral_containers: Io_k8s_api_core_v1_ephemeral_container.t list;
    (* HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified. This is only valid for non-hostNetwork pods. *)
    host_aliases: Io_k8s_api_core_v1_host_alias.t list;
    ...
    init_containers: Io_k8s_api_core_v1_container.t list;
    ...
    readiness_gates: Io_k8s_api_core_v1_pod_readiness_gate.t list;
    (* ResourceClaims defines which ResourceClaims must be allocated and reserved before the Pod is allowed to start. The resources will be made available to those containers which consume them by name.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable. *)
    resource_claims: Io_k8s_api_core_v1_pod_resource_claim.t list;
    ...
    scheduling_gates: Io_k8s_api_core_v1_pod_scheduling_gate.t list;
    ...
    topology_spread_constraints: Io_k8s_api_core_v1_topology_spread_constraint.t list;
    (* List of volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes *)
    volumes: Io_k8s_api_core_v1_volume.t list;
