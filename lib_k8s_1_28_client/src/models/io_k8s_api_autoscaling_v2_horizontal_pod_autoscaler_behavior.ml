...
type t = {
    scale_down: Io_k8s_api_autoscaling_v2_hpa_scaling_rules.t option [@default None];
    scale_up: Io_k8s_api_autoscaling_v2_hpa_scaling_rules.t option [@default None];
