...
type t = {
    ...
    spec: Io_k8s_api_admissionregistration_v1alpha1_validating_admission_policy_spec.t option [@default None] [@key spec];
    status: Io_k8s_api_admissionregistration_v1alpha1_validating_admission_policy_status.t option [@default None] [@key status];
