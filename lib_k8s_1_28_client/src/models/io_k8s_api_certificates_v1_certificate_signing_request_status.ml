...
type t = {
    ...
    certificate: string option [@default None] [@key "certificate"];
    (* conditions applied to the request. Known conditions are \''Approved\'', \''Denied\'', and \''Failed\''. *)
    conditions: Io_k8s_api_certificates_v1_certificate_signing_request_condition.t list [@default []] [@key "conditions"];
