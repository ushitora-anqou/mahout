...
type t = {
    ...
    attach_required: bool option [@default None] [@key attachRequired];
    ...
    fs_group_policy: string option [@default None] [@key fsGroupPolicy];
    ...
    pod_info_on_mount: bool option [@default None] [@key podInfoOnMount];
    ...
    requires_republish: bool option [@default None] [@key requiresRepublish];
    ...
    se_linux_mount: bool option [@default None] [@key seLinuxMount];
    ...
    storage_capacity: bool option [@default None] [@key storageCapacity];
    ...
    token_requests: Io_k8s_api_storage_v1_token_request.t list [@default []] [@key tokenRequests];
    ...
    volume_lifecycle_modes: string list [@default []] [@key volumeLifecycleModes];
