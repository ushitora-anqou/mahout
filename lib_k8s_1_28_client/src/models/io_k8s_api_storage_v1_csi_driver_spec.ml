...
type t = {
    ...
    attach_required: bool option [@default None];
    ...
    fs_group_policy: string option [@default None];
    ...
    pod_info_on_mount: bool option [@default None];
    ...
    requires_republish: bool option [@default None];
    ...
    se_linux_mount: bool option [@default None];
    ...
    storage_capacity: bool option [@default None];
    ...
    token_requests: Io_k8s_api_storage_v1_token_request.t list [@default []];
    ...
    volume_lifecycle_modes: string list [@default []];
