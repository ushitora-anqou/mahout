...
let create_flowcontrol_apiserver_v1beta3_flow_schema ~sw client ~body ?pretty ?dry_run ?field_manager ?field_validation () =
...
let create_flowcontrol_apiserver_v1beta3_priority_level_configuration ~sw client ~body ?pretty ?dry_run ?field_manager ?field_validation () =
...
let delete_flowcontrol_apiserver_v1beta3_collection_flow_schema ~sw client ?pretty ?continue ?dry_run ?field_selector ?grace_period_seconds ?label_selector ?limit ?orphan_dependents ?propagation_policy ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ~body () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let delete_flowcontrol_apiserver_v1beta3_collection_priority_level_configuration ~sw client ?pretty ?continue ?dry_run ?field_selector ?grace_period_seconds ?label_selector ?limit ?orphan_dependents ?propagation_policy ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ~body () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let delete_flowcontrol_apiserver_v1beta3_flow_schema ~sw client ~name ?pretty ?dry_run ?grace_period_seconds ?orphan_dependents ?propagation_policy ~body () =
...
let delete_flowcontrol_apiserver_v1beta3_priority_level_configuration ~sw client ~name ?pretty ?dry_run ?grace_period_seconds ?orphan_dependents ?propagation_policy ~body () =
...
let get_flowcontrol_apiserver_v1beta3_api_resources ~sw client () =
...
let list_flowcontrol_apiserver_v1beta3_flow_schema ~sw client ?pretty ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let list_flowcontrol_apiserver_v1beta3_priority_level_configuration ~sw client ?pretty ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let patch_flowcontrol_apiserver_v1beta3_flow_schema ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let patch_flowcontrol_apiserver_v1beta3_flow_schema_status ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
...
let patch_flowcontrol_apiserver_v1beta3_priority_level_configuration ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let patch_flowcontrol_apiserver_v1beta3_priority_level_configuration_status ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
...
let read_flowcontrol_apiserver_v1beta3_flow_schema ~sw client ~name ?pretty () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let read_flowcontrol_apiserver_v1beta3_flow_schema_status ~sw client ~name ?pretty () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let read_flowcontrol_apiserver_v1beta3_priority_level_configuration ~sw client ~name ?pretty () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let read_flowcontrol_apiserver_v1beta3_priority_level_configuration_status ~sw client ~name ?pretty () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}/status" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let replace_flowcontrol_apiserver_v1beta3_flow_schema ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let replace_flowcontrol_apiserver_v1beta3_flow_schema_status ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let replace_flowcontrol_apiserver_v1beta3_priority_level_configuration ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let replace_flowcontrol_apiserver_v1beta3_priority_level_configuration_status ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}/status" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let watch_flowcontrol_apiserver_v1beta3_flow_schema ~sw client ~name ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
...
let watch_flowcontrol_apiserver_v1beta3_flow_schema_list ~sw client ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
...
let watch_flowcontrol_apiserver_v1beta3_priority_level_configuration ~sw client ~name ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
...
let watch_flowcontrol_apiserver_v1beta3_priority_level_configuration_list ~sw client ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
