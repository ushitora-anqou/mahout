...
let create_admissionregistration_v1beta1_validating_admission_policy ~sw client ?(headers = Request.default_headers) ~body ?pretty ?dry_run ?field_manager ?field_validation () =
...
let create_admissionregistration_v1beta1_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ~body ?pretty ?dry_run ?field_manager ?field_validation () =
...
let delete_admissionregistration_v1beta1_collection_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ?pretty ?continue ?dry_run ?field_selector ?grace_period_seconds ?label_selector ?limit ?orphan_dependents ?propagation_policy ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ~body () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
    let uri = Request.maybe_add_query_param uri "continue" (fun x -> x) continue in
...
let delete_admissionregistration_v1beta1_validating_admission_policy ~sw client ?(headers = Request.default_headers) ~name ?pretty ?dry_run ?grace_period_seconds ?orphan_dependents ?propagation_policy ~body () =
...
let delete_admissionregistration_v1beta1_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ~name ?pretty ?dry_run ?grace_period_seconds ?orphan_dependents ?propagation_policy ~body () =
...
let get_admissionregistration_v1beta1_api_resources ~sw client ?(headers = Request.default_headers) () =
...
let list_admissionregistration_v1beta1_validating_admission_policy ~sw client ?(headers = Request.default_headers) ?pretty ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let list_admissionregistration_v1beta1_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ?pretty ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
    let uri = Request.maybe_add_query_param uri "allowWatchBookmarks" string_of_bool allow_watch_bookmarks in
...
let patch_admissionregistration_v1beta1_validating_admission_policy ~sw client ?(headers = Request.default_headers) ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let patch_admissionregistration_v1beta1_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings/{name}" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let patch_admissionregistration_v1beta1_validating_admission_policy_status ~sw client ?(headers = Request.default_headers) ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
...
let read_admissionregistration_v1beta1_validating_admission_policy ~sw client ?(headers = Request.default_headers) ~name ?pretty () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let read_admissionregistration_v1beta1_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ~name ?pretty () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings/{name}" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let read_admissionregistration_v1beta1_validating_admission_policy_status ~sw client ?(headers = Request.default_headers) ~name ?pretty () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}/status" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let replace_admissionregistration_v1beta1_validating_admission_policy ~sw client ?(headers = Request.default_headers) ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let replace_admissionregistration_v1beta1_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings/{name}" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let replace_admissionregistration_v1beta1_validating_admission_policy_status ~sw client ?(headers = Request.default_headers) ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}/status" in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let watch_admissionregistration_v1beta1_validating_admission_policy ~sw client ?(headers = Request.default_headers) ~name ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
...
let watch_admissionregistration_v1beta1_validating_admission_policy_binding ~sw client ?(headers = Request.default_headers) ~name ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
...
let watch_admissionregistration_v1beta1_validating_admission_policy_binding_list ~sw client ?(headers = Request.default_headers) ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
...
let watch_admissionregistration_v1beta1_validating_admission_policy_list ~sw client ?(headers = Request.default_headers) ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
