...
let create_authentication_v1alpha1_self_subject_review ~sw client ~body ?dry_run ?field_manager ?field_validation ?pretty () =
...
let get_authentication_v1alpha1_api_resources ~sw client () =
