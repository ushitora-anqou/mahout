...
let create_certificates_v1alpha1_cluster_trust_bundle ~sw client ~body ?pretty ?dry_run ?field_manager ?field_validation () =
...
let delete_certificates_v1alpha1_cluster_trust_bundle ~sw client ~name ?pretty ?dry_run ?grace_period_seconds ?orphan_dependents ?propagation_policy ~body () =
...
let delete_certificates_v1alpha1_collection_cluster_trust_bundle ~sw client ?pretty ?continue ?dry_run ?field_selector ?grace_period_seconds ?label_selector ?limit ?orphan_dependents ?propagation_policy ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ~body () =
    let uri = Request.build_uri "/apis/certificates.k8s.io/v1alpha1/clustertrustbundles" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let get_certificates_v1alpha1_api_resources ~sw client () =
...
let list_certificates_v1alpha1_cluster_trust_bundle ~sw client ?pretty ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
    let uri = Request.build_uri "/apis/certificates.k8s.io/v1alpha1/clustertrustbundles" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.maybe_add_query_param uri "pretty" (fun x -> x) pretty in
...
let patch_certificates_v1alpha1_cluster_trust_bundle ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation ?force () =
    let uri = Request.build_uri "/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let read_certificates_v1alpha1_cluster_trust_bundle ~sw client ~name ?pretty () =
    let uri = Request.build_uri "/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let replace_certificates_v1alpha1_cluster_trust_bundle ~sw client ~name ~body ?pretty ?dry_run ?field_manager ?field_validation () =
    let uri = Request.build_uri "/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "authorization" Request.api_key in
    let uri = Request.replace_path_param uri "name" (fun x -> x) name in
...
let watch_certificates_v1alpha1_cluster_trust_bundle ~sw client ~name ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
...
let watch_certificates_v1alpha1_cluster_trust_bundle_list ~sw client ?allow_watch_bookmarks ?continue ?field_selector ?label_selector ?limit ?pretty ?resource_version ?resource_version_match ?send_initial_events ?timeout_seconds ?watch () =
